...
common and widely accepted measure of teacher quality is VA\footnote{The
  ...
  (\citeyear{chettyI}\protect\hyperlink{ref-chettyI}{a})
  and Chetty, Friedman, and Rockoff
  (\citeyear{chettyII}\protect\hyperlink{ref-chettyII}{b}),
...
\citeyear{dpi}), and will serve as the primary source
of data on teachers in this chapter. Data are available at the
...
and mobility\footnote{HKR mention they failed to adjust the standard
  ...
  as a result.}. We run a similar regression, but evaluate separate regressions not
...
\begin{table}
\begin{center}
\begin{adjustbox}{width=\textwidth,totalheight=.85\textheight,keepaspectratio}
